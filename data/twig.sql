...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : lun. 19 juin 2023 à 09:57
...
--
DROP DATABASE IF EXISTS `twig`;
CREATE DATABASE IF NOT EXISTS `twig` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
USE `twig`;
